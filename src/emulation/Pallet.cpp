#include "Pallet.h"
Pallet::Pallet(uint16_t addr) : palletAddr(addr), shades{ WHITE, WHITE, WHITE, WHITE } {}
...
bool Pallet::accepts(uint16_t addr) { return addr == palletAddr; }
Pallet::Shade Pallet::operator[](uint8_t n) { return shades.at(n); }
