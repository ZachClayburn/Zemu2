...
IndirectLoadFromPrefixAndParameter::IndirectLoadFromPrefixAndParameter(IBus *busIn, CPURegisters *registersIn) : Operation(LENGTH), bus(busIn), registers(registersIn) {}
